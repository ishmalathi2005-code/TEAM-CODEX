...
import { Terminal, Shield, CheckCircle, Bot, Code2 } from 'lucide-react';
...
export const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center relative overflow-hidden text-slate-100">
      ...
      <div className="absolute top-1/2 -right-40 w-96 h-96 bg-indigo-500/15 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDelay: '2s' }} />
      <div className="absolute -bottom-40 left-1/3 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDelay: '4s' }} />
          ...
          <div className="lg:col-span-6 flex flex-col justify-center space-y-8 p-4 lg:pr-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-none">
                Elevate Your <br />
                <span className="bg-gradient-to-r from-cyan-400 via-brand-400 to-indigo-400 bg-clip-text text-transparent">Tech Interview</span> Mastery.
              </h1>
            ...
            <div className="p-4 rounded-xl glass-panel border-cyan-500/30 font-mono text-xs text-slate-300 hidden sm:block relative overflow-hidden">
              ...
              <div className="glass-panel p-6 sm:p-8 rounded-2xl relative overflow-hidden">
                ...
                <div className="mb-6 text-center sm:text-left">
                  <div className="flex items-center justify-center sm:justify-start space-x-2 mb-2">
                    ...
                    <span className="font-display text-xl font-bold tracking-wider text-slate-100">
                      CODEX<span className="text-cyan-400">.AI</span>
                    </span>
                  </div>
                  <h2 className="text-2xl font-bold text-slate-100 font-display">{title}</h2>
